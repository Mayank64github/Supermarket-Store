		...
		if (mysqli_num_rows($query) > 0) {
			...
			echo "<form method='post' action='login_form.php'>";
				...
				echo '<div class="row">
							...
							<div class="col-md-4">
								<b class="" style="font-size:20px;">Total : Rs'.$total.' </b><br>
				...
				/*if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="shoppingcart@Vkstore.com">
							...
							echo
								'<input type="hidden" name="return" value="http://localhost/MyProject/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/MyProject/payment_success.php">
